namespace Repository
{
    ...
    public class ScheduleRepository : BaseRepository, IScheduleRepository
    {
        ...
        private const string GetScheduleCapeAverageProcedure = "GetCapeRatingUsingSchedID";
        ...
        public float GetScheduleCapeAverage(int scheduleID, ref List<string> errors)
        {
            ...
            try
            {
                var adapter = new SqlDataAdapter(GetScheduleCapeAverageProcedure, conn);
                ...
                for (var i = 0; i < dataSet.Tables[0].Rows.Count; i++)
                {
                    sum += Convert.ToInt32(dataSet.Tables[0].Rows[i]["rating"].ToString());
                    count += 1;
                }
            }
            catch (Exception e)
